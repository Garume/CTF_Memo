...
int1 = int_generator(num1)
print("num1:{}".format(num1))
print("int_generator(num1):{}".format(int1))
inv1_true = inv_int_generator(int1,True)
inv1_false = inv_int_generator(int1,False)
print("original_true:{}".format(inv1_true))
print("original_false:{}".format(inv1_false))

print(num1)
print(str(inv1_true//100) + "   len:" + str(len(str(inv1_true))))
print(str(inv1_false) + "   len:" + str(len(str(inv1_false))))
